	...
	public function index() {
		if (!$this->tank_auth->is_logged_in()) {
			...
			$config['toolbar'] = array(
				array( 'Source', '-', 'Bold', 'Italic', 'Underline', 'Strike' , '-', 'NumberedList', 'BulletedList', '-', 'Outdent', 'Indent'),
				array( 'Image', 'Link', 'Unlink', 'Anchor' )
				/*,array( 'RemoveFormat', 'Styles', 'Format', 'Font', 'FontSize' )*/
			);
			...
			$this->load->view('admin/ckeditor_ckfinder',$data);
		}
	}
}